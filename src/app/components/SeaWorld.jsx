...
const SeaWorld = () => {
    ...
    const seaPals = [
        ...
        {name: 'Dolphin', author: 'Akka', type: 'image', src: '/images/SeaPals/Dolphin.jpg', hbdText: "Kzee boo boo, you are amazing!!! You are turning 22 and graduating at the same time!! You would look damn good in that saree I just wish I was in person to see you add another year to yoour amazing life. Cher d to new year of making good decisions and achieving everything you wish for ever. Akka loves you. I will see you soon 💖", whoAmIText: "Kzee? She’s more than a sister—she’s my forever sidekick, my partner in every wild idea this ocean can throw at us. When she was little, I saw her as this adorable little doll our parents had given me, fragile but full of boundless energy. I’d drag her into every bit of mischief I could find: hiding in coral caves, stirring up harmless pranks, exploring the deep waters. Sure, I might’ve gotten a bit too rough once—like the time I accidentally bumped her nose… but she always forgave me, her eyes sparkling with that endless curiosity. As she grew up, Kzee became more than my little sidekick—she turned into this radiant, fearless spirit with her own kind of magic. She’s still my Kzee, the one who’ll ride the currents with me and dream up our next adventure. No one, not even a life partner, could ever fill her place. She’s my sister, my best friend, and the heart of every escapade we dive into together. Happy birthday, Kzee—may our waves together never end."},
